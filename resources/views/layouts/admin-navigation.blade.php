<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <!-- Wastas -->
        <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/wasta*') ? 'active' : '' }}"
                href="{{ url('/admin/wasta') }}">
                <i class="fa-solid fa-user-doctor menu-icon"></i>
                <span class="menu-title">Wastas</span>
            </a>
        </li>
        ...
        <!-- Payment Manager -->
        <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/manage-payment*') ? 'active' : '' }}"
