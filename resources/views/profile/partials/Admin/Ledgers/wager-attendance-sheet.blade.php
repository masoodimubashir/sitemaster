<x-app-layout>
    ...
    <!-- Attendance Edit Modal (add after all modals) -->
                ...
                <div class="modal-body">
                    <form id="attendanceEditForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="modalPrice" name="price" placeholder="Enter price">
                        </div>
                    </form>
                </div>
                <div class="modal-footer py-2">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary btn-sm" id="saveAttendanceBtn">Save changes</button>
                </div>
            </div>
        </div>
    </div>
