                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center pe-4">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        @if($user === 'admin')
                                                        <form action="{{ url($user . '/clients/' . $client->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" 
                            ...
                            @else
                                <div class="alert alert-light text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <p class="text-muted mb-4">There are no client records available at the moment.</p>
                                        <a class="btn btn-primary" href="{{ url($user . '/clients/create') }}">
                                            <i class="fas fa-user-plus me-1"></i>
                                            Create New Client
                                        </a>
                                    </div>
